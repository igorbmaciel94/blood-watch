...
[Migration("20260215190000_InitialCreate")]
public partial class InitialCreate : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.InsertData(
            table: "sources",
            columns: new[] { "Id", "adapter_key", "name", "created_at_utc" },
            columnTypes: new[] { "uuid", "text", "text", "timestamp with time zone" },
            values: new object[]
            {
                new Guid("51abf65a-c68a-4bc7-b9f2-3f8f3a9bb2b1"),
                "pt-transparencia-sns",
                "Portugal SNS Transparency",
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.DropTable(name: "snapshot_items");
